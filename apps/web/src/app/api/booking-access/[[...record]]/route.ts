...
export const GET=async(r:Request)=>{
 try{const runtime=bookingAccessRuntime();if(runtime)return bookingAccessHandler(runtime.access,runtime.p.contexts,runtime.p.r.config.origin,undefined,runtime.recovery)(r);}catch{}
