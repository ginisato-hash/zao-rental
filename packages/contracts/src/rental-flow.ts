...
export interface PaymentGateway{readonly kind:'SIMULATED_DEV'|'SQUARE_UNCONNECTED';create(request:PaymentRequest):Promise<PaymentObservation>;lookup(request:PaymentRequest,providerId:string|null):Promise<PaymentObservation|null>;}
