...
export type IncomingPhoto={filename:string;bytes:Buffer;binding:{modelId:string;season:string;sport:'SKI'|'SNOWBOARD';role:'COVER'|'DETAIL'|'LIFESTYLE'|'INTERNAL_IDENTITY';rightsEvidence:string|null}|null};
