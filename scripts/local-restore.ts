...
export const RESTORE_REQUIRED=[
 ...
 'public.ops_amendments','public.ops_amendment_quotes','public.ops_charge_requests','public.ops_refund_requests','public.ops_financial_alerts','public.ops_history','public.ops_stocktakes','public.ops_stocktake_reconciliations','public.ops_receipt_terms','public.ops_exceptions','public.field_acceptance_records','public.ops_import_sources','public.ops_import_stages','public.ops_import_commits',
...
export const CRITICAL=['public.rental_bookings','public.price_quotes','public.rental_payment_attempts','public.inventory_holds','public.inventory_claims','public.rental_loan_items','public.rental_receipts','public.transfer_batches','public.transfer_pieces','public.ops_amendments','public.ops_refund_requests','public.ops_exceptions','public.field_acceptance_records','public.booking_notification_outbox','public.rental_history','public.ops_history'] as const;
