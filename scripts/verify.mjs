...
const commands = [];
for (const name of ['check:reference', 'check:secrets', 'test:reference', 'lint', 'typecheck', 'test:unit', ...(process.platform === 'darwin' ? ['test:controller:macos'] : []), 'test:integration', 'test:inventory', 'test:transfer', 'test:pricing', 'test:recommendation', 'build', 'test:auth', 'test:holds-ui', 'test:transfers-ui', 'test:quotes-ui', 'test:recommendations-ui', 'test:recommendation-audit', 'test:recommendation-continuation', 'test:stabilization-s01', 'test:stabilization-upgrade', 'test:stabilization-cd', 'test:stabilization-eg', 'test:stabilization-mixed', 'test:square-activation', 'test:flow-payment', 'test:flow-ui', 'test:asset-reader', 'test:flow-restart', 'test:flow-scope-race', 'test:custody', 'test:custody-ui', 'test:late-pickup', 'test:wear', 'test:wear-ui', 'test:wear-mixed', 'test:content-fixture', 'test:public-guest', 'test:public-content', 'test:public-ui', 'test:staff-diagnostic', 'test:readiness-guest', 'test:readiness-ui', 'test:integration-p2', 'test:activation-p4', 'test:booking-recovery', 'test:booking-recovery-ui', 'test:production-rehearsal', 'test:r15-regression', 'test:avatar', 'test:operations', 'test:operations-ui', 'test:operations-console', 'test:operations-console-ui', 'test:operations-restore', 'test:operations-baseline', 'test:m2a-import', 'test:m2a-connection', 'test:m2a-rehearsal', 'test:m2a-launch', 'test:m2a-launch-ui', 'test:m2b-security', 'test:production-runtime', 'test:production-runtime-ui', 'test:notification', 'test:notification-ui', 'test:e2e']) {
