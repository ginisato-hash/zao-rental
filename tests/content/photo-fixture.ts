...
export class PhotoFileFixture implements PhotoJobStore{
 ...
 transaction<T>(fn:(jobs:Record<string,PhotoJob>,context:{offers:readonly string[]})=>Promise<T>){return this.file.edit(async r=>fn(r.photoJobs??={},{offers:Object.keys(r.state.catalog.commercialRevisions)}));}
